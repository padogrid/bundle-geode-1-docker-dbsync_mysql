...
# configure MapStorePkDbImpl in the $CLUSTER_DIR/etc/cache.xml file.
...
# If set, the 'start_member' command will run this script instead of com.geode.core.server.StartServer.
